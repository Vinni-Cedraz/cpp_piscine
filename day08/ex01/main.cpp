...
static Span randSpan(size_t size, int range, int seed) {
  ...
  for (size_t i = 0; i < size; i++) span.addNumber(rand() % range);
  return (span);
}
...
int main(void) {
  ...
  std::cout << std::endl;
  {
    std::cout << "TEST 2 (ERROR HANDLING)" << std::endl;
    Span a(5);
    std::cout << "Create an empty Span" << std::endl;
  ...
  std::cout << std::endl;
  {
    std::cout << "TEST 3 (SHORTEST SPAN AND LONGEST SPAN)" << std::endl;
  ...
  std::cout << std::endl;
  {
    ...
    // std::cout << "TEST 4 (VERY LARGE RANDOM)" << std::endl;
  ...
  std::cout << std::endl;
  {
  	std::cout << "TEST 5 (RANGE OF ITERATORS)" << std::endl;
  	std::deque<int>	test;
  	test.push_back(1);
  	test.push_back(2);
  	test.push_back(3);
